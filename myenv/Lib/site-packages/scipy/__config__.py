...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.14.0",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-qjiwhfk5\overlay\Lib\site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-8hexkyrv\cp310-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.10",
        },
    }
)
